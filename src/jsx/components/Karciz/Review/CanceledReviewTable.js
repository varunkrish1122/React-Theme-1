...
const CanceledReviewTable = () => {
  const [data, setData] = useState(
    document.querySelectorAll("#example1_Review tbody tr")
  );
  const sort = 6;
  ...
  // use effect
  useEffect(() => {
    setData(document.querySelectorAll("#example1_Review tbody tr"));
    //chackboxFun();
  }, [test]);
  ...
  return (
    <div id="All" className="tab-pane">
      <div className="table-responsive fs-14">
        <div id="example1_Review" className="dataTables_wrapper no-footer">
          <table
            id="example2"
              ...
              <tr role="row" className="odd">
                ...
                <td>
                  <div className="d-flex">
                    ...
                    <Link
                      to=""
                      className="btn btn-danger  btn-sm light ms-2 px-4"
                    >
                      Delete
                    </Link>
                  </div>
...
export default CanceledReviewTable;
